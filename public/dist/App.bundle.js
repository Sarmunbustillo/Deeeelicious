...
function ajaxHeart(e) {
  ...
  _axios2.default.post(this.action).then(function (res) {
    //accessing children of this (the form element) with a name attribute = to heart ( the btn)
  ...
  _axios2.default.get('/api/stores/near?lat=' + lat + '&lng=' + lng).then(function (res) {
    ...
    var markers = places.map(function (place) {
      var _place$location$coord = _slicedToArray(place.location.coordinates, 2),
          placeLgn = _place$location$coord[0],
          placeLat = _place$location$coord[1];

      var position = { lat: placeLat, lng: placeLgn };
    ...
    //zoom the map to fit all the bounce perfectly
...
var heartFomrs = (0, _bling.$$)('form.heart');
heartFomrs.on('submit', _heart2.default);
